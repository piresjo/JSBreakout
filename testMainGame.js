...
console.log(ballTest.showXVelocity() === 2);
console.log(ballTest.showYVelocity() === 2);
console.log(ballTest.showIsDead() === false);
console.log(ballTest.atTopWall(600) === false);
console.log(ballTest.atSideWalls(300) === false);
console.log(ballTest.isBallDead() === false);
console.log("");
...
rbTestCollide.collision(ballTestCollide);
console.log(ballTestCollide.showYVelocity() === -2);
console.log(rbTestCollide.showIsHit() === true);
console.log("");
